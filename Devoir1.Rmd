...
## II. Relation entre les taux de crime, de chômage et les résultats des votes

Ici, nous explorons la relation entre les taux de crime, de chômage et les résultats des votes pour trois candidats politiques lors des élections présidentielles en France entre 2016 et 2023 : Emmanuel Macron, Marine Le Pen et Jean-Luc Mélenchon. Nous examinons comment ces facteurs sont liés aux résultats électoraux de ces candidats.

Nous avons effectué des régressions linéaires pour étudier les relations entre les taux de crime et de chômage et les résultats des votes pour Macron, Le Pen et Mélenchon.

### a. Régressions linéaires entre taux de crime et résultats des votes

### Pourcentage des votes pour Macron, Le Pen et Mélenchon en fonction des taux de crime
...
ggplot(crime_vote_merge, aes(x = taux_crime_par_1000)) + # Valeur commune sur x, le taux de crime
  ...
  geom_point(aes(y = pourcentage_melenchon, color ="Mélenchon", shape = annee) , alpha = 0.5) +  # Pourcentages Melanchon
  geom_smooth(aes(y = pourcentage_melenchon, color ="Mélenchon"), method = "lm", se = TRUE) +  # Regression linéaire pour Melanchon
  ...
  labs(title = "Régression comparative entre le taux de crime et les votes sur les candidats",
       ...
       shape = "Année") +
  theme_minimal() +
  scale_color_manual(values = c("Macron" = "blue", "Le Pen" = "red", "Mélenchon" = "purple")) +
...
Ce graphique nous permet de comparer les tendances des votes pour les trois candidats face aux taux de crime. Il inclut également une différenciation selon l'année. On voit ici que Mélanchon a un taux de criminalité plus élevé parmis ses électeurs en comparaison aux deux autres candidats. On peut déduire ici que Mélanchon est principalement voté dans les villes, où la majeure partie des crimes sont concentrés. On constate l'opposé pour Le Pen, plus votée dans les campagnes.

### b. Régressions linéaires entre taux de chômage et résultats des votes

### Pourcentage des votes pour Macron, Le Pen et Mélenchon en fonction des taux de chômage
...
Ce graphique nous permet de comparer les tendances des votes pour les trois candidats face au taux de chômage. On voit ici que Le Pen a un taux de chômage plus élevé parmis ses électeurs en comparaison aux deux autres candidats. Comme dit précédemment, Le Pen est principalement voté dans les campagnes, où la le taux de chômage y est plus élevé. On constate l'opposé pour Mélanchon, plus votée dans les villes, et Macron, voté partout en France.

### Conclusion`

Les analyses effectuées mettent en lumière les relations entre les taux de crime, de chômage et les résultats des votes pour Macron, Le Pen et Mélenchon. Ces résultats suggèrent comment ces facteurs peuvent influencer les préférences politiques des électeurs.

Nous pouvons approfondir notre étude en examinant d'autres variables telles que l'éducation ou l'économie pour obtenir une perspective plus complète de l'impact de ces facteurs sur les résultats des élections.
