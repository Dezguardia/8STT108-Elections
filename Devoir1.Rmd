...
```
Dans cette section, nous avons utilisé l'algorithme k-NN pour classer les données en fonction des votes pour chaque candidat. La précision du modèle k-NN a été évaluée et affichée. On peut ajuster la valeur de k en fonction de nos préférences.